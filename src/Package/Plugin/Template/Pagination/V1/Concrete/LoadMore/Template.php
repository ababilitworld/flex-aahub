...
namespace Ababilithub\FlexAahub\Package\Plugin\Template\Pagination\V1\Concrete\LoadMore;
    ...
    public function render(array $data = []): string
    {
        ...
        <nav class="<?php echo esc_attr($classes); ?>"
            ...
            <button class="faih-pagination-button faih-pagination-load-more" type="button" data-load-more>
                <?php echo esc_html((string) $labels['load_more']); ?>
            </button>
        </nav>
        <?php
