<?php
namespace Ababilithub\FlexAahub\Package\Plugin\Template\V1\Concrete\Theme;
...
class Template extends BaseTemplate
{
    ...
    {
         // Compute the absolute URL to the Template folder (4 levels up from this file)
    ...
    // echo "<pre>"; print_r(array($this->asset_base_prefix, $this->asset_base_url, $this->asset_base_url.'Template/Css/Theme/V1/Manager/Style.css')); echo "</pre>"; //exit;
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_style(
            ...
            $this->asset_base_url.'Template/Css/Framework/V1/Concrete/Ababilithub/Style.css',
            array(), 
            time()
        );
        ...
        //     $this->asset_base_url.'Template/Css/Layo/V1/Manager/Style.css',
        //     array(), 
        //     time()
        // );
