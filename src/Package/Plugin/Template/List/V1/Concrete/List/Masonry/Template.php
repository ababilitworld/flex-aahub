...
use Ababilithub\FlexWordpress\Package\Template\V1\Contract\ListTemplate\ListTemplate as ListTemplateContract;

abstract class ListTemplate extends Template implements ListTemplateContract
{
